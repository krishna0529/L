                    ...
                    <ul class="navbar-nav  " >
                        <li class="nav-item me-2">
                            <a href="" class="nav-link ">
                                <h4 class="text-light " style="overflow: hidden;"> </h4>
                            </a>
                        </li>
                        ...
                        <li class="nav-item me-4">
                            <a href="" class="nav-link  me-4">
                                <h4 class="text-light"><?php // username(); ?></h4>
                            </a>
                        </li>
                        <li class="nav-item me-4">
        ...
        <div class="row">
            <div class=" bg-dark p-1 me-2 d-flex align-item-center">
                ...
                <div class="button text-center td p-5  m-auto">
                    ...
                    <button class="bg-success bt"><a href="./Adashboard.php?all_order" class="nav-link text-light my-2">All Order</a></button>
                    <button class="bg-success bt"><a href="./Adashboard.php?payment" class="nav-link text-light my-2">ALL Payments</a></button>
                    <button class="bg-success bt"><a href="./Adashboard.php?list_users" class="nav-link text-light my-2">List Users</a></button>
