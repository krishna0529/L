...
if (isset($_POST['edit_product'])) {
    ...
    if ($product_title == '' or $product_description == '' or $product_keyword == '' or $product_category == '' or $product_price==''  or $product_image1 =='') {
        ...
        $update_query ="UPDATE `product` SET `product_title`='$product_title',`product_description`='$product_description',`product_keyword`='$product_keyword',`category_id`='$product_category',`product_price`='$product_price',`product_image1`='$product_image1',`date`=NOW() WHERE product_id=$edit_id";
