...
if(isset($_POST['insert_product'])){
    ...
    if($product_title=='' or $product_description=='' or $product_keyword=='' or $product_category=='' or  $product_price=='' or  $product_image1=='' ){
        ...
        //insert Query 
        $insert_product = "INSERT INTO `product`(`product_id`, `product_title`, `product_description`, `product_keyword`, `category_id`, `product_image1`,  `date`, `status`) VALUES ('','$product_title','$product_description','$product_keyword','$product_category','$product_price','$product_image1','NOW()','$product_status' )";
