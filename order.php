...
$insert_order = "INSERT INTO `user_orders`( `user_id`, `amount_due`, `invoice_number`, `total_products`,  `order_status`) VALUES ('$user_id','$subtotal','$invoice_number','$count_products','$status')";

$result_query=mysqli_query($connection,$insert_order);
if($result_query){
    echo"<script>alert('Oreder are submitted Successfully ')</script>";
...
$result_pending_order=mysqli_query($connection,$insert_pending_order);
