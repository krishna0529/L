...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM users WHERE email='{$email}'")) > 0) {
        ...
        if ($password === $confirm_password) {
            ...
            $sql = "INSERT INTO `users`( `name`, `email`, `password`, `image`,`ip`,`address`,`mobile`, `code`) VALUES ('$name','{$email}','{$password}','{$images}','$ip','$address','$mobile','{$code}')";
                ...
                <div class="main-mockup">
                    ...
                    <div class="content-wthree">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <input type="text" class="name" name="address" placeholder="Enter Your Address" value="<?php if (isset($_POST['submit'])) {
                                                                                                                        echo $address;
                                                                                                                    } ?>" required> 
                                                                                                                    
                            <input type="text" class="name" name="mobile" placeholder="Enter Your mobile Number" value="<?php if (isset($_POST['submit'])) {
                                                                                                                        echo $mobile;
                                                                                                                    } ?>" required>                                                                                        
